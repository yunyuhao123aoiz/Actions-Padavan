...
#define DEF_WLAN_2G_SSID	BOARD_PID "PHICOMM_%s"
#define DEF_WLAN_5G_SSID	BOARD_PID "PHICOMM_5G_%s"
#define DEF_WLAN_2G_GSSID	BOARD_PID "PHICOMM_GUEST_%s"
#define DEF_WLAN_5G_GSSID	BOARD_PID "PHICOMM_GUEST_5G_%s"
